...
export default async function decorate(block) {
  ...
  const fragment = document.createRange().createContextualFragment(`
    <div class="product-details-3__alert"></div>
    <div class="product-details-3__wrapper">
      <div class="product-details-3__left-column">
        <div class="product-details-3__gallery"></div>
      </div>
      <div class="product-details-3__right-column">
        <div class="product-details-3__header"></div>
        <div class="product-details-3__price"></div>
        <div class="product-details-3__gallery"></div>
        <div class="product-details-3__short-description"></div>
        <div class="product-details-3__gift-card-options"></div>
        <div class="product-details-3__configuration">
          <div class="product-details-3__options"></div>
          <div class="product-details-3__quantity"></div>
          <div class="product-details-3__buttons">
            <div class="product-details-3__buttons__add-to-cart"></div>
            <div class="product-details-3__buttons__add-to-wishlist"></div>
          </div>
        </div>
        <div class="product-details-3__description"></div>
        <div class="product-details-3__attributes"></div>
      </div>
    </div>
  `);

  const $alert = fragment.querySelector('.product-details-3__alert');
  const $gallery = fragment.querySelector('.product-details-3__gallery');
  const $header = fragment.querySelector('.product-details-3__header');
  const $price = fragment.querySelector('.product-details-3__price');
  const $galleryMobile = fragment.querySelector('.product-details-3__right-column .product-details-3__gallery');
  const $shortDescription = fragment.querySelector('.product-details-3__short-description');
  const $options = fragment.querySelector('.product-details-3__options');
  const $quantity = fragment.querySelector('.product-details-3__quantity');
  const $giftCardOptions = fragment.querySelector('.product-details-3__gift-card-options');
  const $addToCart = fragment.querySelector('.product-details-3__buttons__add-to-cart');
  const $wishlistToggleBtn = fragment.querySelector('.product-details-3__buttons__add-to-wishlist');
  const $description = fragment.querySelector('.product-details-3__description');
  const $attributes = fragment.querySelector('.product-details-3__attributes');

...
The `promotional-hero-2` block renders a responsive campaign card grid with image-first cards, optional description copy, and one CTA per card.
...
Author using a **3-column** `promotional-hero-2` table.

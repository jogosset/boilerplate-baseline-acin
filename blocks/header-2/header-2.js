...
document.querySelector('header-2').insertAdjacentElement('afterbegin', overlay);
...
subMenuHeader.classList.add('submenu-header-2');
...
/**
 * loads and decorates the header-2, mainly the nav
 * @param {Element} block The header-2 block element
 */

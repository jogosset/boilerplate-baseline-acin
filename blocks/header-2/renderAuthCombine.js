  ...
  if (accountLi) {
    ...
    authCombineLink.addEventListener('click', (event) => {
      ...
      function getPopupElements() {
        const header-2Block = document.querySelector('.header-2.block');
        const header-2LoginButton = document.querySelector('#header-2-login-button');
      ...
      events.on('authenticated', (isAuthenticated) => {
        ...
        if (isAuthenticated) {
          const { header-2LoginButton, popupElement, popupMenuContainer } = getPopupElements();
          ...
          if (header-2LoginButton) {
            const spanElementText = header-2LoginButton.querySelector('span');

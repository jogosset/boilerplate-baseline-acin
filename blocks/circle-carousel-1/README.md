...
- `--circle-carousel-1-gap` - Space between circles

**Circles:**
- `--circle-carousel-1-circle-size` - 120px on desktop
- `--circle-carousel-1-circle-size-mobile` - 100px on mobile
...
/* Adjust circle size */
:root {
  --circle-carousel-1-circle-size: 150px;
  --circle-carousel-1-circle-size-mobile: 120px;
}

/* Change transition speed */
:root {
  --circle-carousel-1-transition: transform 0.8s ease;
}

/* Modify circle styling */
.circle-carousel-1-circle {
  border-width: 4px;
  box-shadow: 0 6px 16px rgba(0 0 0 / 15%);
}

/* Adjust hover effect */
.circle-carousel-1-circle:hover {

...
The `hero-cta-1` block is a media-first hero with optional sidebar navigation and metadata-driven CTA styling.
...
Author using a **4-column** `hero-cta-1` table.
...
- it is styled as `.hero-cta-1-sidebar-header`,
- no URL is required.

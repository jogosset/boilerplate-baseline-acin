...
export default async function decorate(block) {
  ...
  updateMessage.className = 'commerce-mini-cart-1__update-message';

  // Create shadow wrapper
  const shadowWrapper = document.createElement('div');
  shadowWrapper.className = 'commerce-mini-cart-1__message-wrapper';
  shadowWrapper.appendChild(updateMessage);

  const showMessage = (message) => {
    updateMessage.textContent = message;
    updateMessage.classList.add('commerce-mini-cart-1__update-message--visible');
    shadowWrapper.classList.add('commerce-mini-cart-1__message-wrapper--visible');
    setTimeout(() => {
      updateMessage.classList.remove(
        'commerce-mini-cart-1__update-message--visible',
      );
      shadowWrapper.classList.remove(
        'commerce-mini-cart-1__message-wrapper--visible',
      );
    }, 3000);
  };

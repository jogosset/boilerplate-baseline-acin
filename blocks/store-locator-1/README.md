...
- Verify on page with:
  - `document.querySelector('main > .section.store-locator-1-container')?.dataset.width`
...
- Lint status:
  - `npx eslint blocks/store-locator-1/store-locator-1.js`
  - `npx stylelint blocks/store-locator-1/store-locator-1.css`

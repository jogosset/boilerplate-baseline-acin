...
function createSearchSection(
  ...
  section.classList.add('store-locator-1-search');
  ...
  title.classList.add('store-locator-1-title');
  title.textContent = 'Find Your Nearest Store';
  section.appendChild(title);

  const subtitle = document.createElement('p');
  subtitle.classList.add('store-locator-1-subtitle');
...
/**
 * Main decorate function for store-locator-1 block
 * @param {Element} block - The store-locator-1 block element
 */
export default async function decorate(block) {
  ...
  container.classList.add('store-locator-1-container');
  ...
  contentArea.classList.add('store-locator-1-content');

...
- First column: Image (optional) - Automatically styled as `cards-2-card-image`
- Subsequent columns: Body content - Automatically styled as `cards-2-card-body`
...
- **Equal Sizing**: All cards-2 in a row have equal width
...
1. **Content Display**: Block renders all provided rows as individual cards-2 in a grid layout
...
- **Empty Cards**: Empty rows are still rendered as cards-2 with appropriate spacing

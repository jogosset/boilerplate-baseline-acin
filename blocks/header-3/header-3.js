...
document.querySelector('header-3').insertAdjacentElement('afterbegin', overlay);
...
subMenuHeader.classList.add('submenu-header-3');
...
/**
 * loads and decorates the header-3, mainly the nav
 * @param {Element} block The header-3 block element
 */

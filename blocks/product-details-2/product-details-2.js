...
export default async function decorate(block) {
  ...
  const fragment = document.createRange().createContextualFragment(`
    <div class="product-details-2__alert"></div>
    <div class="product-details-2__wrapper">
      <div class="product-details-2__left-column">
        <div class="product-details-2__gallery"></div>
      </div>
      <div class="product-details-2__right-column">
        <div class="product-details-2__header"></div>
        <div class="product-details-2__price"></div>
        <div class="product-details-2__gallery"></div>
        <div class="product-details-2__short-description"></div>
        <div class="product-details-2__configuration">
          <div class="product-details-2__options"></div>
          <div class="product-details-2__quantity"></div>
          <div class="product-details-2__buttons">
            <div class="product-details-2__buttons__add-to-cart"></div>
            <div class="product-details-2__buttons__add-to-wishlist"></div>
          </div>
        </div>
        <div class="product-details-2__description"></div>
        <div class="product-details-2__attributes"></div>
      </div>
    </div>
  `);

  const $alert = fragment.querySelector('.product-details-2__alert');
  const $gallery = fragment.querySelector('.product-details-2__gallery');
  const $header = fragment.querySelector('.product-details-2__header');
  const $price = fragment.querySelector('.product-details-2__price');
  const $galleryMobile = fragment.querySelector('.product-details-2__right-column .product-details-2__gallery');
  const $shortDescription = fragment.querySelector('.product-details-2__short-description');
  const $options = fragment.querySelector('.product-details-2__options');
  const $quantity = fragment.querySelector('.product-details-2__quantity');
  const $addToCart = fragment.querySelector('.product-details-2__buttons__add-to-cart');
  const $wishlistToggleBtn = fragment.querySelector('.product-details-2__buttons__add-to-wishlist');
  const $description = fragment.querySelector('.product-details-2__description');
  const $attributes = fragment.querySelector('.product-details-2__attributes');
